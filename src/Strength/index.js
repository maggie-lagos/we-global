                            ...
                            <Col xs="7" className="facilityDiv">
                                <p>
                                    <h4 className="headerFontSize">
                                        Pushing you to maximium performance with individualized programs
                                    </h4>
                                </p>
                                <p className="textFontSize">
                                    Our strength training programs begin with a complimentary evaluation which we use along with
                                    your personal goals to design individual athletic training programs. All of our programs
                                    are LMPTrainingSolutions, developed by our in-house program director Lynee Pina, and take into
                                    account the specific requirements of a sport and even distinct positions within a team sport.
                                </p>

                                <p className="textFontSize">
                                    Our strength trainers will teach you proper technique and push you to your maximum performance
                                    using a variety of fitness equipment including dumbbells, kettlebells, medicine balls, squat racks,
                                    Vertimax, battle ropes, and much more. Regardless of your athletic level, our training tools and
                                    equipment will be sure to keep you challenged, engaged, and safe.
                                </p>
                                <br />
